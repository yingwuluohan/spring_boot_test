package com.unisound.iot.controller.jvm.ASM;
...
/**
 * @Created by yingwuluohan on 2020/3/18.
 */
public class ASMGettingStarted {
    ...
    {
        String className = "com.unisound.iot.controller.jvm.ASM.AsmTest";
        byte[] classData = createVoidMethod(className, "*******This is my first ASM********");
